...
export default function UserCreateTemplatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const templateRequest = {
      ...
      type,
      entryFee: 0, // User templates are free
      status: 'DRAFT' as const, // User templates start as draft
  ...
  return (
    <div className="container py-8 max-w-4xl">
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl">Create Practice Template</CardTitle>
            <p className="text-muted-foreground">
              Create your own practice template to use for studying
            </p>
          </CardHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Describe your practice template"
                  rows={3}
                />
              </div>
            </div>
